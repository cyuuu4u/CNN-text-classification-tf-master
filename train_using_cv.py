    ...
    with sess.as_default():
        ...
        for cv in range(FLAGS.k_fold):
            ...
            for batch in batches:
                ...
                # 每训练一定数量的batch后就用验证集验证一下看验证集上的loss是否有在持续下降，EARLY STOPPING以解决overfitting的问题
        ...
        for acc in test_max_acc:
            if acc > max_acc:
                max_acc = acc
        print("Testing Accuracy: {:g}".format(max_acc))
